...
std::string ParseFirmwareVersion::readFirmwareVersion(std::vector<uint8_t>::const_iterator data_ptr) const
{
  ...
  {
    result.push_back(ReadWriteHelper::readuint16_tLittleEndian(data_ptr + 2 + i));
  }
  return result;
}
